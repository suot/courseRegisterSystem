...
namespace CourseRegister.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,studentId,courseId,score")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,studentId,courseId,score")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
